...
const querystring=require('querystring'); //get参数获取

function ajax(data) {
    // let baseUrl = "http://uunote.mit.cn/";
    // let baseUrl = "http://aiats.mit.cn";http://192.168.6.108:3002
    let baseUrl = "http://192.168.6.168:9309";
    // let baseUrl = "";
    Ajax({
